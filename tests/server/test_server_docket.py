"""Tests for experimental Docket integration in FastMCP."""
...
def enable_docket():
    """Enable experimental Docket support for all tests in this suite."""
    with temporary_settings(experimental__enable_docket=True):
        yield


async def test_docket_disabled():
    """Verify that Docket errors when experimental flag is disabled."""
    with temporary_settings(experimental__enable_docket=False):
