...
class TestResourceKeyPrefixing:
    """Test that resource and resource template keys (URIs) get prefixed when mounted."""

    async def test_resource_uri_prefixing(self):
        """Test that resource URIs (keys) are prefixed when mounted, but names are not."""
        ...
        # The resource name should NOT be prefixed (only the URI/key is prefixed)
    ...
    async def test_resource_template_uri_prefixing(self):
        """Test that resource template URIs (keys) are prefixed when mounted, but names are not."""
        ...
        # The template name should NOT be prefixed (only the uri_template/key is prefixed)
