...
- **It's polite to reply briefly to a review comment once you've addressed it or decided not to.** A few words — "fixed in abc1234", or the reason if you're leaving it. Nothing depends on it; the timeline already shows whether commits followed the comment.
