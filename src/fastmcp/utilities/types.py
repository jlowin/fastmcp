...
def without_injected_parameters(fn: Callable[..., Any]) -> Callable[..., Any]:
    ...
    """
    from docket.dependencies import get_dependency_parameters
    ...
    # All FastMCP execution contexts are async, so wrapper is always async
    # Return type is Any to avoid forward reference resolution issues
