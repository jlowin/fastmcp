...
class CIMDFetcher:
    ...
    # Maximum number of distinct client documents retained per process
    MAX_CACHE_SIZE = 100
    ...
    def _store_cache_entry(self, client_id_url: str, entry: _CIMDCacheEntry) -> None:
        """Store a document without allowing distinct URLs to grow the cache."""
        if client_id_url not in self._cache and len(self._cache) >= self.MAX_CACHE_SIZE:
