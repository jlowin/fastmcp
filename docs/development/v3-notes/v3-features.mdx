...
List operations expose all available versions in the component's `_meta` field:

```python
tools = await client.list_tools()
# Each tool's _meta includes:
# - _meta.fastmcp.version: the version of this component ("2.0")
# - _meta.fastmcp.versions: all available versions ["2.0", "1.0"]
```
