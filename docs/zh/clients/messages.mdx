...
- **Sampling requests**: Use [`sampling_handler`](/zh/clients/sampling)
- **Progress requests**: Use [`progress_handler`](/zh/clients/progress)
- **Log requests**: Use [`log_handler`](/zh/clients/logging)
