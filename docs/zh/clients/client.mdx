...
For detailed transport configuration (headers, authentication, environment variables), see the [Transports](/zh/clients/transports) documentation.
...
### Core Operations
- **[Tools](/zh/clients/tools)** - Execute server-side functions and handle results
- **[Resources](/zh/clients/resources)** - Access static and templated resources
- **[Prompts](/zh/clients/prompts)** - Work with message templates and argument serialization

### Advanced Features
- **[Logging](/zh/clients/logging)** - Handle server log messages
- **[Progress](/zh/clients/progress)** - Monitor long-running operations
- **[Sampling](/zh/clients/sampling)** - Respond to server LLM requests
- **[Roots](/zh/clients/roots)** - Provide local context to servers

### Connection Details
- **[Transports](/zh/clients/transports)** - Configure connection methods and parameters
- **[Authentication](/zh/clients/auth/oauth)** - Set up OAuth and bearer token authentication
