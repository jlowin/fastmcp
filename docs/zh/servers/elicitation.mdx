...
Elicitation requires the client to implement an elicitation handler. See [Client Elicitation](/zh/clients/elicitation) for details on how clients can handle these requests.
