...
Clients can handle these notifications using a [message handler](/zh/clients/messages) to automatically refresh their resource lists or update their interfaces.
