...
<Tip>
Learn more about working with OpenAPI specs in the [OpenAPI integration docs](/zh/integrations/openapi).
</Tip>
...
<Tip>
Learn more about the FastMCP client in the [client docs](/zh/clients/client).
</Tip>
...
<Tip>
Learn more about route maps in the [OpenAPI integration docs](/zh/integrations/openapi#route-mapping).
</Tip>
