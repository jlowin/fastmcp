...
Make sure you have FastMCP installed. If not, follow the [installation guide](/zh/getting-started/installation).
...
python my_mcp_server.py
```
This starts the server using the default **STDIO transport**, which is how clients like Claude Desktop communicate with local servers. To learn about other transports, like HTTP, see the [Running Your Server](/zh/deployment/running-server) guide.
...
-   [**Tools in Depth**](/zh/servers/tools): Learn about asynchronous tools, error handling, and custom return types.
-   [**Resources & Templates**](/zh/servers/resources): Discover different resource types, including files and HTTP endpoints.
-   [**Prompts**](/zh/servers/prompts): Create reusable prompt templates for your LLM.
-   [**Running Your Server**](/zh/deployment/running-server): Deploy your server with different transports like HTTP.
