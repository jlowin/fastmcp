...
[**Learn more about Tools →**](/zh/servers/tools)
...
[**Learn more about Resources & Templates →**](/zh/servers/resources)
...
[**Learn more about Prompts →**](/zh/servers/prompts)
...
[**Tutorial: How to Create an MCP Server in Python →**](/zh/tutorials/create-mcp-server)
