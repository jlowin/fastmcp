...
In addition, any page can be accessed as markdown by appending `.md` to the URL. For example, this page would become `https://fastmcp.wiki/en/getting-started/welcome.md`, which you can view [here](/en/getting-started/welcome.md).
