...
python my_mcp_server.py
```
This starts the server using the default **STDIO transport**, which is how clients like Claude Desktop communicate with local servers. To learn about other transports, like HTTP, see the [Running Your Server](/en/deployment/running-server) guide.
...
-   [**Tools in Depth**](/en/servers/tools): Learn about asynchronous tools, error handling, and custom return types.
-   [**Resources & Templates**](/en/servers/resources): Discover different resource types, including files and HTTP endpoints.
-   [**Prompts**](/en/servers/prompts): Create reusable prompt templates for your LLM.
-   [**Running Your Server**](/en/deployment/running-server): Deploy your server with different transports like HTTP.
