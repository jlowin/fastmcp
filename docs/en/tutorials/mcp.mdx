...
[**Learn more about Tools →**](/en/servers/tools)
...
[**Learn more about Resources & Templates →**](/en/servers/resources)
...
[**Learn more about Prompts →**](/en/servers/prompts)
...
[**Tutorial: How to Create an MCP Server in Python →**](/en/tutorials/create-mcp-server)
