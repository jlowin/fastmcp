...
See [Tools](/en/clients/tools) for detailed documentation.
...
See [Resources](/en/clients/resources) for detailed documentation.
...
See [Prompts](/en/clients/prompts) for detailed documentation.
...
For detailed transport configuration (headers, authentication, environment variables), see the [Transports](/en/clients/transports) documentation.
...
### Core Operations
- **[Tools](/en/clients/tools)** - Execute server-side functions and handle results
- **[Resources](/en/clients/resources)** - Access static and templated resources
- **[Prompts](/en/clients/prompts)** - Work with message templates and argument serialization
...
### Connection Details
- **[Transports](/en/clients/transports)** - Configure connection methods and parameters
- **[Authentication](/en/clients/auth/oauth)** - Set up OAuth and bearer token authentication
