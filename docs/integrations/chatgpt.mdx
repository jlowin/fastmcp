...
More information about the `inspectr` CLI tool and its configuration options can be found in the [Inspectr documentation](https://inspectr.dev/docs/configuration/cli-options/).
