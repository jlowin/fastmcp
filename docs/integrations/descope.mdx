...
auth_provider = DescopeProvider(
    ...
    # Optional: Add required_scopes=["your-scope"] to enforce specific permissions
)
...
<ParamField path="FASTMCP_SERVER_AUTH_DESCOPEPROVIDER_REQUIRED_SCOPES" default="[]">
...
FASTMCP_SERVER_AUTH_DESCOPEPROVIDER_REQUIRED_SCOPES=openid,profile,email
```
