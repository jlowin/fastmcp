...
This integration uses Goose's deeplink protocol to register your server as a STDIO extension running via `uvx`. Goose must be installed on your system for the deeplink to open automatically.
