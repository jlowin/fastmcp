...
1. Get a [Scalekit account](https://app.scalekit.com/) and grab your **Environment URL** plus the **Resource ID** you plan to protect from _Dashboard > Developers > Settings_.
2. Have your FastMCP server's base URL ready (can be localhost for development, e.g., `http://localhost:8000/mcp`)
...
<Card>
<ParamField path="FASTMCP_SERVER_AUTH_SCALEKIT_ENVIRONMENT_URL" required>
Your Scalekit environment URL from the Admin Portal (e.g., `https://your-env.scalekit.com`)
</ParamField>

<ParamField path="FASTMCP_SERVER_AUTH_SCALEKIT_RESOURCE_ID" required>
Your Scalekit resource server ID from the Resources section
</ParamField>

<ParamField path="FASTMCP_SERVER_AUTH_SCALEKIT_BASE_URL" required>
Public URL of your FastMCP server (e.g., `https://your-server.com` or `http://localhost:8000/mcp` for development)
</ParamField>

<ParamField path="FASTMCP_SERVER_AUTH_SCALEKIT_REQUIRED_SCOPES" default="[]">
...
FASTMCP_SERVER_AUTH_SCALEKIT_ENVIRONMENT_URL=https://your-env.scalekit.com
FASTMCP_SERVER_AUTH_SCALEKIT_RESOURCE_ID=res_456
FASTMCP_SERVER_AUTH_SCALEKIT_BASE_URL=https://your-server.com/mcp
