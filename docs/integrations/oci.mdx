...
<Step title: Update Domain Setting>
    ...
    Enable "Configure client access" checkbox as show in the screenshot.
...
<Step title: Update OAuth Configuration for an Integrated Application>
    ...
    For Authorization grant type, select redirect URL. This is, in most cases, will be MCP server URL followed by "/oauth/callback".
