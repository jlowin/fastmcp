...
<Step title="Navigate to OCI IAM Domain Settings">
    ...
    ![Edit IAM Domain Settings](./images/oci/ocieditdomainsettingsbutton.png)
</Step>
...
<Step title="Update Domain Setting">
    ...
    ![IAM Domain Settings](./images/oci/ocieditdomainsettings.png)
</Step>
</Steps>
...
<Step title="Add an Integrated Application">
    ...
    ![Add Confidential Integrated Application](./images/oci/ociaddapplication.png)
</Step>
...
<Step title="Update OAuth Configuration for an Integrated Application">
    ...
    ![OAuth Configuration for an Integrated Application](./images/oci/ocioauthconfiguration.png)
</Step>
...
<Step title="Activate the Integrated Application">
    ...
    **Note: You don't need to do any special configuration to support PKCE for the OAuth client.**
    ...
    Note down client ID and client secret for the application. Update .env file and replace IAM_CLIENT_ID and IAM_CLIENT_SECRET values. 
    IAM_DOMAIN in the env file is the Identity domain URL that you chose for the MCP server.
</Step>
</Steps>
...
Your OCI Application Configuration URL (e.g., `https://{IAM_GUID}.identity.oraclecloud.com/.well-known/openid-configuration`)
</ParamField>
...
FASTMCP_SERVER_AUTH_OCI_CONFIG_URL=https://{IAM_GUID}.identity.oraclecloud.com/.well-known/openid-configuration
