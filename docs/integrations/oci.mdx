...
def get_oci_signer() -> TokenExchangeSigner:
    ...
    signer = TokenExchangeSigner(
        jwt_or_func=token,
        oci_domain_id=FASTMCP_SERVER_AUTH_OCI_IAM_GUID
...
auth_provider = OCIProvider(
    config_url="http://idcs-acsasdasc....identity.oraclecloud.com/.well-known/openid-configuration",
    client_id="acsadsasccasdas........",
    client_secret="idcsssasaweacew.....",
