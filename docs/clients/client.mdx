...
client = Client(
    ...
    timeout=5.0  # Default timeout in seconds for all requests
)
...
async with client:
    ...
    # This specifies a shorter 1-second timeout for this specific call
    try:
        result3 = await client.call_tool("medium_task", {"param": "value"}, timeout=1.0)
