...
See [Transports](/connect/transports) for detailed configuration options including authentication headers, session persistence, and multi-server configurations.
...
See [Tools](/connect/tools) for detailed documentation including version selection, error handling, and structured output.
...
See [Resources](/connect/resources) for detailed documentation including templates and binary content.
...
See [Prompts](/connect/prompts) for detailed documentation including argument serialization.
...
- **[Sampling](/connect/sampling)** - Respond to server LLM requests
- **[Elicitation](/connect/elicitation)** - Handle server requests for user input
- **[Progress](/connect/progress)** - Monitor long-running operations
- **[Logging](/connect/logging)** - Handle server log messages
- **[Roots](/connect/roots)** - Provide local context to servers
