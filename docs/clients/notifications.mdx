...
- **Sampling requests**: Use [`sampling_handler`](/connect/sampling)
- **Elicitation requests**: Use [`elicitation_handler`](/connect/elicitation)
- **Progress updates**: Use [`progress_handler`](/connect/progress)
- **Log messages**: Use [`log_handler`](/connect/logging)
