...
By default, all CIMD clients show a consent screen with their verified domain before authorization. The consent screen displays the client's domain name (extracted from the CIMD document URL) to help you verify the client's identity.
