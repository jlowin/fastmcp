...
The consent page automatically displays your server's name and icon (from the `FastMCP` instance's `icons` property), if available. This visual identifier helps users confirm they're authorizing the correct server.
