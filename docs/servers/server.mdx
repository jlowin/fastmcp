...
<ParamField body="icons" type="list[Icon] | None">
  ...
  List of icon representations for your server. Icons help users visually identify your server in client applications. See [Icons](/build/design/icons) for detailed examples
</ParamField>
...
See [Tools](/build/components/tools-overview) for detailed documentation.
...
See [Resources](/build/components/resources-overview) for detailed documentation.
...
See [Resource Templates](/build/components/resource-templates) for detailed documentation.
...
See [Prompts](/build/components/prompts-overview) for detailed documentation.
