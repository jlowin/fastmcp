...
The decorator:
1. Wraps your function in a try/except block
2. Catches httpx exceptions and maps them to appropriate messages
3. Logs the original exception for debugging
4. Raises `ToolError` with the user-friendly message
5. Chains the original exception for debugging (`__cause__`)
