...
@mcp.tool(task=True)
async def plan_dinner(ctx: Context) -> str | mcp.types.InputRequiredResult:
    ...
    if responses is None:
        ...
        return mcp.types.InputRequiredResult(
    ...
    assert isinstance(answer, mcp.types.ElicitResult)
