...
Dependency injection in FastMCP follows a simple pattern: declare a parameter with a dependency as its default value, and FastMCP injects the resolved value at runtime.
