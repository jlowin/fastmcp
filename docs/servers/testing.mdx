...
<Tip>
For values that change you can leverage the [dirty-equals](https://github.com/samuelcolvin/dirty-equals) library to assert that the value is close to the expected value.
</Tip>
