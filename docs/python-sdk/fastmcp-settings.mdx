...
#### `server_auth_class` <sup><a href="https://github.com/jlowin/fastmcp/blob/main/src/fastmcp/settings.py#L369" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
